...
const StaffSidebar = ({ user }) => {
  ...
  const menuItems = [
    { name: "Dashboard", icon: <FaHome />, path: "/staff/StaffDashboard" },
    {
      name: "CAPD Patients", icon: <FaUserInjured />, subItems: [
        { name: "Patients Lists", path: "/staff/OutpatientList" }
      ]
    },
    { name: "Appointments", icon: <FaCalendarAlt />, path: "/staff/PatientScheduleList" },
    // { name: "Doctors' Queue Status", icon: <FaUserMd />, path: "/staff/StaffDoctorsStatus" }
  ];
      ...
      <Aside $mobileMenuOpen={mobileMenuOpen}>
        ...
        {user && (
          <UserInfoTop>
            ...
            <UserRole>CAPD Medical Staff</UserRole>
          </UserInfoTop>
        )}
