...
function Login() {
  ...
  const handleCredentialUpdateSuccess = () => {
    ...
    setNotification({ message: 'Registration completed successfully! Please login with your new credentials.', type: 'success' });
        ...
        {notification.message && (
          <motion.div
            ...
            style={{
              ...
              right: '1rem',
              padding: '1rem',
              backgroundColor: theme.notification[notification.type]?.bg || theme.notification.info.bg,
              color: theme.notification[notification.type]?.text || theme.notification.info.text,
              ...
              maxWidth: '100%',
              borderLeft: `4px solid ${theme.notification[notification.type]?.text || theme.notification.info.text}`,
